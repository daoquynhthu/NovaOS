...
impl Endpoint {
    ...
    pub fn reply_recv_with_mrs(
        &self,
        info: libnova::ipc::MessageInfo,
        mrs: [u64; 4],
    ) -> (libnova::ipc::MessageInfo, seL4_Word, [u64; 4]) {
        ...
        let (badge, resp_info) =
            libnova::ipc::reply_recv(self.cptr, info).expect("IPC ReplyRecv failed");
